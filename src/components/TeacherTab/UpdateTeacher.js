  ...
  return (
    <>
      <div className=' space-y-[6px]'>
        <CustomInput name={"username"} autoComplete={"username"} keyboardType={"default"} placeholder={"Kullanıcı Adı"} control={control} />
        <CustomInput name={"email"} autoComplete={"email"} placeholder={"E-posta Adresi"} control={control} />
